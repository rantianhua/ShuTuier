...
public class Constants {
    ...
    public static final String TYPE_MYSELL =  "出售";
    public static final String TYPE_MYSEND = "赠送";
    public static final String TYPE_MYASKSEND = "求赠送";
    public static final String TYPE_MYASKBUY = "求购";
