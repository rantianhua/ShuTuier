...
public class Constants {
    ...
    public static final String OLink = "http://www.tengshufang.com/API/get?mode=";
    public static final String DetailLink = "http://www.tengshufang.com/API/item?id=";
    public static final String ShareLink = "http://www.tengshufang.com/book?book=";
    public static String CommentsLink = "http://www.tengshufang.com/API/mark";
    public static String COMMITLINK = "http://www.tengshufang.com/API/publish";
    public static String LOGINLINK = "http://www.tengshufang.com/API/login";
    public static String PICLINK = "http://7xi56i.com1.z0.glb.clouddn.com/";
    public static String BASEMYCOMMIT = "http://www.tengshufang.com/API/getMe?mode=";
    public static final String CHANGEBOOK = "http://www.tengshufang.com/API/change";
    public static final String CHANGEUSERINFO = "http://www.tengshufang.com/API/info";
    public static final String SEARCHLINK = "http://www.tengshufang.com/API/search?content=";
    public static final String SHARENOTIFYLINK = "http://www.tengshufang.com/API/share?bookID=";
    public static final String MESSAGENUMBERLINK = "http://www.tengshufang.com/API/message?openId=";
    public static final String MESSAGELISTLINK = "http://www.tengshufang.com/API/getMsg?openId=";
    ...
    public static final String[] SCIENCE = {"科普","互联网","科学","交互设计","用户体验","通信","编程"};
    ...
    public static final String Address =  "school";
    public static final String USERICONFILE = "/user_icon.jpg";
    public static final String TYPE_MYSELL =  "0";
    public static final String TYPE_MYSEND = "2";
    public static final String TYPE_MYASKSEND = "3";
    public static final String TYPE_MYASKBUY = "1";
    public static final String HANDLE_BOOK_ACTION = "handle_action";
    public static final String HANDLE_BOOK_POSITION = "handle_position";
    public static final String HANDLE_BOOK_ID = "handle_book_id";
    public static final String HANDLE_BOOK_PRESTATE = "handle_book_prestate";
    public static final String QQ_FIGURE1 = "figureurl_qq_1";
    public static final String QQ_FIGURE2 = "figureurl_qq_2";
